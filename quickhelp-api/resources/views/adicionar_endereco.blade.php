...
<head>
    ...
    <title>Adicionar Endereço - Quickhelp</title>
</head>
<body>
    <div class="container">
        <!-- Sidebar -->
        ...
        <div class="main-content">
            ...
            <form id="addressForm" style="max-width: 58%">
    ...
    <script>
        ...
        document.getElementById('addressForm').addEventListener('submit', async function(e) {
            ...
            const formData = {
                ...
                state_address: document.getElementById('state').value,
                city_address: document.getElementById('city').value,
                neighborhood_address: document.getElementById('neighborhood').value,
                street_address: document.getElementById('street').value,
                number_address: document.getElementById('number').value,
                complement_address: document.getElementById('complement').value
            };
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    responseDiv.innerHTML = '<p style="color:var(--main-color);">Erro ao adicionar endereço!</p>';
                }
            } catch (error) {
